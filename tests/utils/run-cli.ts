...
export function runJitiCli(modulePath: string): Promise<{ stdout: string; stderr: string }> {
...
export function runUnrunCli(modulePath: string): Promise<{ stdout: string; stderr: string }> {
